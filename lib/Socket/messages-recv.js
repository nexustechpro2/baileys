...
export const makeMessagesRecvSocket = (config) => {
  ...
  const sendMessagesAgain = async (key, ids, retryNode) => {
    ...
    // Don't force-refresh sessions during message receipt - causes libsignal to detect stale sessions
    // Let the decryption process handle session validation naturally
