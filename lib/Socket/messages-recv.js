...
export const makeMessagesRecvSocket = (config) => {
  ...
  const handleMessage = async (node) => {
    ...
    const { fullMessage: msg, category, author, decrypt } = decryptMessageNode(node, authState.creds.me.id, authState.creds.me.lid || "", signalRepository, logger, assertSessions)
