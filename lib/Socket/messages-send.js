...
export const makeMessagesSocket = (config) => {
    ...
    return {
        ...
        stickerPackMessage: (jid, data, options) => nexus.handleStickerPack(data, jid, options?.quoted, { name: options?.packName || data?.name, publisher: options?.packPublisher || data?.publisher, }),
        sendMessage,
        // Shorthand wrappers
