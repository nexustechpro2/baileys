...
const reportingFields = [
    ...
    { f: 93, s: [{ f: 1, m: true }] },
    { f: 94, s: [{ f: 1, m: true }] },
    // newer message types from WA 2.3000.1047787617
    { f: 97, s: [{ f: 2 }, { f: 3, s: [{ f: 1 }] }, { f: 4, s: [{ f: 21 }, { f: 22 }] }] }, // richResponseMessage
    { f: 98, s: [{ f: 1 }, { f: 2 }] }, // statusNotificationMessage
    { f: 100, s: [{ f: 1, m: true }] }, // botTaskMessage
    { f: 101, s: [{ f: 1, m: true }] }, // questionMessage
    { f: 103, s: [{ f: 1, m: true }] }, // groupStatusMessageV2
    { f: 104, s: [{ f: 1, m: true }] }, // botForwardedMessage
    { f: 105, s: [{ f: 1 }, { f: 2 }] }, // statusQuestionAnswerMessage
    { f: 107, s: [{ f: 1 }, { f: 2 }] }, // questionResponseMessage
    { f: 109, s: [{ f: 1 }, { f: 2 }, { f: 3 }, { f: 4 }] }, // statusQuotedMessage
    { f: 111, s: [{ f: 2 }, { f: 3, s: [{ f: 1 }, { f: 2 }] }, { f: 5, s: [{ f: 21 }, { f: 22 }] }, { f: 8, s: [{ f: 1 }, { f: 2 }] }] }, // pollCreationMessageV5
    { f: 115, s: [{ f: 1 }, { f: 2, s: [{ f: 1 }] }, { f: 3, s: [{ f: 21 }, { f: 22 }] }] }, // pollResultSnapshotMessageV3
    { f: 119, s: [{ f: 2 }, { f: 3, s: [{ f: 1 }, { f: 2 }] }, { f: 5, s: [{ f: 21 }, { f: 22 }] }, { f: 8, s: [{ f: 1 }, { f: 2 }] }] }, // pollCreationMessageV6
    { f: 125, s: [{ f: 1 }, { f: 2, s: [{ f: 1 }] }, { f: 3 }, { f: 4 }] }, // splitPaymentMessage
    { f: 129, s: [{ f: 1, m: true }] }, // musicMessage
]
...
export const shouldIncludeReportingToken = (message) =>
    ...
    !message.statusStickerInteractionMessage && !message.encCommentMessage
