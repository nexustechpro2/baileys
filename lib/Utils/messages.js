    ...
    if (mediaType === 'sticker') {
        try {
            ...
            if (isWebp) {
                ...
                const converted = await new Sticker(rawBuf, { pack: packName, author: authorName, type: stickerType, quality: message.quality || options?.quality || 80 }).toBuffer()
                uploadData.media = await shrinkToLimit(converted, { animated: false })
            }
